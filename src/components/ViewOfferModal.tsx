...
const ViewOfferModal = ({
  ...
  const [step, setStep] = useState<"view" | "processing" | "cancelled">("view");
      ...
      <DialogContent className="sm:max-w-md p-0 bg-cream border-champagne/30 overflow-hidden [&>button]:hidden">
        ...
        {step === "view" && (
          <div className="px-6 pb-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Countered Price</span>
                <span className="text-charcoal font-medium">{counteredPrice.toLocaleString()} {token}</span>
              </div>
              <div className="flex items-center justify-between">
        ...
        {step === "processing" && (
          <div className="px-6 pb-6 py-12 flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-charcoal font-medium">Cancelling offer...</p>
