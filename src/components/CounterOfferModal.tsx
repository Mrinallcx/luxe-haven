      ...
      <DialogContent className="sm:max-w-md p-0 bg-cream border-champagne/30 overflow-hidden [&>button]:hidden">
          ...
          <div className="px-6 pb-6 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-charcoal font-medium">{originalPrice.toLocaleString()} {token}</span>
              </div>
              <div className="flex items-center justify-between">
            ...
            <div className="space-y-2">
              <label className="text-sm text-muted-foreground">Your Counter Price</label>
              <div className="relative">
                <Input
                  ...
                  className="bg-white border-charcoal/20 text-charcoal pr-16 h-12"
                />
              ...
              <div className="flex items-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-charcoal text-cream">
                      <p>A small fee for processing your counter offer</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              <span className="text-charcoal font-medium">{serviceCharge} LCX</span>
            </div>
            ...
            <Button
              ...
              className="w-full rounded-full bg-gold hover:bg-gold/90 text-charcoal font-medium py-6 disabled:opacity-50"
            >
        ...
        {step === "processing" && (
          <div className="px-6 pb-6 py-12 flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-charcoal font-medium">Processing counter offer...</p>
            <p className="text-sm text-muted-foreground">Please wait while we submit your offer</p>
          </div>
        )}
